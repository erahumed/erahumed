...
The full set of simulation parameters is documented in `?erahumed_simulation` (see [here](https://erahumed.github.io/erahumed-book/chapters/model-inputs.html) for
a table format).
