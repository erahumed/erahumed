test_that("get_management_df() succeeds", {
  expect_no_error(get_management_df(default_rfms_map()))
})

test_that("get_applications_df() succeeds", {
  expect_no_error(get_applications_df(default_rfms_map()))
})

test_that("get_chemical_db() succeeds", {
  expect_no_error(get_chemical_db(default_rfms_map()))
})

test_that("get_chemical_db() has the correct length in fixed case", {
  obj <- get_chemical_db(default_rfms_map())
