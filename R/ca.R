...
ca <- function(hbp_res,
               ...
               height_thresh_cm = 2)
{
  ca_argcheck(hbp_res, ca_schedules_df, height_thresh_cm)
...
ca_argcheck <- function(hbp_res, ca_schedules_df, height_thresh_cm)
{
  tryCatch({
    stopifnot(inherits(hbp_res, "erahumed_hbp"))
